...
- **New partners**: if someone's phone number isn't in the database yet, the check-in page tells them to ask staff — add them via **Partners → + Add partner**, then they can check in.
